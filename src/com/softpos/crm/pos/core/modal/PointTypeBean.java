...
public class PointTypeBean {
    ...
    public float getBahtRatePerPoint1() {
        return BahtRatePerPoint1;
    }

    public void setBahtRatePerPoint1(float BahtRatePerPoint1) {
    ...
    public float getBahtRatePerPoint2() {
        return BahtRatePerPoint2;
    }

    public void setBahtRatePerPoint2(float BahtRatePerPoint2) {
    ...
    public float getBahtRatePerPoint3() {
        return BahtRatePerPoint3;
    }

    public void setBahtRatePerPoint3(float BahtRatePerPoint3) {
