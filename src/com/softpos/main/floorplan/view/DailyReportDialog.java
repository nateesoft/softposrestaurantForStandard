...
//        setBounds(GraphicsEnvironment.getLocalGraphicsEnvironment().getMaximumWindowBounds());
    ...
    private void initComponents() {
        ...
        bntExit.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/buttons/close.png"))); // NOI18N
        ...
        setSize(new java.awt.Dimension(950, 579));
        setLocationRelativeTo(null);
...
//        ClearApp();
    ...
    public void bntOkClick() {
        PosUserBean posUser = PosControl.getPosUser(PublicVar.ReturnString);
        ...
        if (FunctionList.getSelectedIndex() == 14) {
            if (!MSG.CONF(this, "การพิมพ์รายงานอัตโนมัติรวมทุกเครื่อง เป็นการสิ้นสุดการขายสินค้าของวันนั้น หลังจากพิมพ์รายงานนี้แล้วจะไม่สามารถทำรายการขายได้อีก \n ยืนยันการพิมพ์รายงานสรุปยอดการขายหรือไม่ (Y/N)?... ")) {
                return;
            }
            PublicVar.TempUserRec = PublicVar.TUserRec;
