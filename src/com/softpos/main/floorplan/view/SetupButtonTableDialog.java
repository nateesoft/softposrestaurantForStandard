...
public class SetupButtonTableDialog extends javax.swing.JDialog {
    ...
    public SetupButtonTableDialog(java.awt.Frame parent, boolean modal, String codeId) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        btnDel.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/buttons/delete.png"))); // NOI18N
        btnDel.setText("ลบรายการ");
    ...
    private void deleteItem(String codeId) {
        ...
        try {
            ...
            AppLogUtil.log(SetupButtonTableDialog.class, "error", e);
        } finally {
