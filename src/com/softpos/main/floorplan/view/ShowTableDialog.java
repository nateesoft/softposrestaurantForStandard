...
public class ShowTableDialog extends javax.swing.JDialog {

    private DefaultTableModel model2;
    static SimpleDateFormat Datefmtshow = new SimpleDateFormat("dd/MM/yyyy", Locale.ENGLISH);

    public ShowTableDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
    ...
    private void initComponents() {
        ...
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/buttons/check.png"))); // NOI18N
        jButton1.setText("เลือกโต๊ะ");
