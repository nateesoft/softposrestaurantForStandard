...
import com.softpos.main.program.CouponDiscountDialog;
...
public class DiscountDialog extends javax.swing.JDialog {
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(txtCupon, javax.swing.GroupLayout.DEFAULT_SIZE, 95, Short.MAX_VALUE)
                            .addComponent(txtTrain)
                            .addComponent(txtMem)
                            .addComponent(txtEmp))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(txtEmpAmt)
                            .addComponent(txtMemAmt)
                            .addComponent(txtTrainAmt)
                            .addComponent(txtCuponAmt)))
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addComponent(txtFest, javax.swing.GroupLayout.PREFERRED_SIZE, 95, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addComponent(txtFestAmt, javax.swing.GroupLayout.PREFERRED_SIZE, 123, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addContainerGap())
        );
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        if (totalDiscAll > totalAmount && totalAmount > 0) {
            MSG.WAR(this, "จำนวนส่วนลดเกินจำนวนเงินรับชำระ กรุณาตรวจสอบ !");
            return;
        }
        ...
        if (EmpDiscount > 0) {
            updateDiscountBalanceDiscClick("EmpDiscount", tableNo);
        }
        if (TrainDiscount > 0) {
            updateDiscountBalanceDiscClick("TrainDiscount", tableNo);
        }
        if (chkInputAmt()) {
    ...
    private void updateDiscountBalanceDiscClick(String type, String tableNo) {
        ...
        switch (type) {
            case "EmpDiscount":
                //เช็ค %การให้ส่วนลดจากหน้าจอ
                data = txtEmp.getText().replace(",", "").split("/");
                String discForN = "";
                String discForC = "";
                String discForS = "";
                ...
                double typeNormalS = 0;
                for (String data1 : typeDisc) {
                ...
                String[] saleTypeDiscCheck = posConfig.getP_DiscChkBySaleType().split("/");
                String saleTypeE = "";
                String saleTypeT = "";
                String saleTypeD = "";
                String saleTypeP = "";
    ...
    private void btnCuponSpecialActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCuponSpecialActionPerformed
        ...
        CouponDiscountDialog cd = new CouponDiscountDialog(null, true, tableNo, Member1, Member2, this.totalAmount);
        cd.setVisible(true);
...
//            this.dispose();
    ...
    private String nextDiscountFest() {
        ...
        String strFestDisc = DISC_EE + "/" + DISC_TT + "/" + DISC_DD;
    ...
    private String nextMem() {
        ...
        String strMemDisc = DISC_EE + "/" + DISC_TT + "/" + DISC_DD;
    ...
    private String nextTrainFest() {
        ...
        String strTrainAmt = DISC_EE + "/" + DISC_TT + "/" + DISC_DD;
    ...
    private String nextSubFest() {
        ...
        String strCuponAmt = DISC_EE + "/" + DISC_TT + "/" + DISC_DD;
    ...
    private void CheckDis1() {
        POSConfigSetup configSetup = PosControl.getData();
        txtFest.setText(configSetup.getP_FastDisc());
        nextFest();
    }

    private void CheckDis2() {
        POSConfigSetup configSetup = PosControl.getData();
        txtEmp.setText(configSetup.getP_EmpDisc());
        nextEmp();
    }

    private void CheckDis3() {
        POSConfigSetup configSetup = PosControl.getData();
        txtMem.setText(configSetup.getP_MemDisc());
        nextMem();
    }

    private void CheckDis4() {
        POSConfigSetup configSetup = PosControl.getData();
        txtTrain.setText(configSetup.getP_TrainDisc());
        nextTrain();
    }

    private void CheckDis5() {
        POSConfigSetup configSetup = PosControl.getData();
        txtCupon.setText(configSetup.getP_SubDisc());
        nextSubDisc();
    }
