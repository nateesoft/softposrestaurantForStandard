...
public class ArHistory extends javax.swing.JDialog {
     ...
     */
    public ArHistory(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
    ...
    private void initComponents() {
        ...
        tblShow.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "รหัสลูกค้า", "ชื่อลูกค้า/ลูกหนี้", "วันที่ซื้อ", "เลขที่ใบเสร็จ", "ใบแจ้งหนี้ (Inv)", "จำนวนเงิน", "ชำระเงิน", "วันที่ชำระ", "ชำระโดย", "เลขที่บิล"
            }
        ) {
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGap(2, 2, 2)
                .addComponent(arcode1, javax.swing.GroupLayout.PREFERRED_SIZE, 72, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(2, 2, 2)
                .addComponent(jButton5, javax.swing.GroupLayout.PREFERRED_SIZE, 35, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(5, 5, 5)
                .addComponent(jLabel2)
                .addGap(6, 6, 6)
                .addComponent(arcode2, javax.swing.GroupLayout.PREFERRED_SIZE, 77, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(2, 2, 2)
        ...
        bntOk.setPreferredSize(new java.awt.Dimension(97, 70));
        ...
        bntPrint.setMinimumSize(new java.awt.Dimension(80, 70));
        ...
        bntExit.setMinimumSize(new java.awt.Dimension(80, 70));
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(bntOk, javax.swing.GroupLayout.PREFERRED_SIZE, 117, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(bntPrint, javax.swing.GroupLayout.PREFERRED_SIZE, 105, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(bntOk, javax.swing.GroupLayout.PREFERRED_SIZE, 0, Short.MAX_VALUE)
                    .addComponent(bntPrint, javax.swing.GroupLayout.PREFERRED_SIZE, 0, Short.MAX_VALUE)
                    .addComponent(bntExit, javax.swing.GroupLayout.PREFERRED_SIZE, 0, Short.MAX_VALUE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
...
private void cmdDateChoose3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdDateChoose3ActionPerformed
            ...
            if (!Value.getComPort().equals("NONE")) {
                if (Value.printdriver) {
                    ...
                    if (prn.OpenPrint(Value.getComPort())) {
                        ...
                        prn.print("    รายงานประวัติการซื้อของลูกหนี้");
    ...
    public void PrintARHistoryDriver() {
        String t = "";
        try {
            String TempCode1 = arcode1.getText();
            String TempCode2;
            ...
            t += "colspan=3 align=center><font face=Angsana New size=1>" + ("รายงานประวัติการซื้อของลูกหนี้") + "_";
            ...
            t += "colspan=3 align=left><font face=Angsana New size=1>" + ("รหัสลูกหนี้" + Space + TempCode1 + Space + " ถึง " + Space + TempCode2) + "_";
            t += "colspan=3 align=left><font face=Angsana New size=1>" + "ช่วงวันที่ " + ardate1.getText() + " ถึง " + ardate2.getText() + "_";
            t += "colspan=3 align=center><font face=Angsana New size=1>" + "_";
            t += "colspan=3 align=center><font face=Angsana New size=1>" + ("----------------------------------------") + "_";
            t += "colspan=3 align=left><font face=Angsana New size=1>" + ("ลูกหนี้    วันที่      เลขที่เอกสาร     จำนวนเงิน") + "_";
