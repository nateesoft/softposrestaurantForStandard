...
public class Jdi_dailyReport_Topsale extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        if (tblDept.getColumnModel().getColumnCount() > 0) {
            ...
            tblDept.getColumnModel().getColumn(0).setPreferredWidth(130);
            tblDept.getColumnModel().getColumn(1).setResizable(false);
            tblDept.getColumnModel().getColumn(1).setPreferredWidth(200);
            tblDept.getColumnModel().getColumn(2).setResizable(false);
            tblDept.getColumnModel().getColumn(2).setPreferredWidth(70);
            tblDept.getColumnModel().getColumn(3).setResizable(false);
            tblDept.getColumnModel().getColumn(4).setResizable(false);
            tblDept.getColumnModel().getColumn(4).setPreferredWidth(250);
            tblDept.getColumnModel().getColumn(5).setResizable(false);
            tblDept.getColumnModel().getColumn(5).setPreferredWidth(100);
