...
public class GiftVoucherReport extends javax.swing.JDialog {
     ...
     */
    public GiftVoucherReport(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
            ...
            if (!POSHW.getPRNPort().equals("NONE")) {
                if (prn.openPrint(POSHW.getPRNPort())) {
                    ...
                    try {
                        ...
                        AppLogUtil.log(GiftVoucherReport.class, "error", e);
                    } finally {
