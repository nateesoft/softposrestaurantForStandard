...
private void cmdDateChoose1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdDateChoose1ActionPerformed
    ...
    DateFrom = txtDate1.getText();
    DateTo = txtDate2.getText();
    txtDate1.requestFocus();
...
//    }
    ...
    public void MTDPluPrintDriver() {
        ...
        t += "colspan=3 align=center><font face=Angsana New size=1>" + ("(MTD PLU Report)") + "_";
        t += "colspan=3 align=center><font face=Angsana New size=1>_";
        t += "colspan=3 align=left><font face=Angsana New size=1>" + ("ช่วงวันที่ : " + DatefmtShow.format(TDate1) + "..." + Space + DatefmtShow.format(TDate2)) + "_";
        t += "colspan=3 align=left><font face=Angsana New size=1>" + ("รหัสกลุ่มสินค้า (Dept/Group) " + txtMacNo1.getText() + "..." + Space + txtMacNo2.getText()) + "_";
...
//                t += "colspan=3 align=left><font face=Angsana New size=1>" + (rs.getString("s_pcode") + Space + PUtility.DataFullR(PUtility.SeekProductName(rs.getString("s_pcode")), 25)) + "_";
                t += "colspan=3 align=left><font face=Angsana New size=1>" + (rs.getString("s_pcode")) + "_";
                t += "colspan=3 align=left><font face=Angsana New size=1>" + (Space + PUtility.DataFullR(PUtility.SeekProductName(rs.getString("s_pcode")), 25)) + "_";
        ...
        t += "align=right><font face=Angsana New size=1>" + (PUtility.DataFull(IntFmt.format(SumDQty), 6) + TAB + PUtility.DataFull(DecFmt.format(SumDAmt), 13) + "</td><td align=right><font face=Angsana New size=1>" + PUtility.DataFull(IntFmt.format(SumPQty), 6) + TAB + PUtility.DataFull(DecFmt.format(SumPAmt), 13)) + "_";
